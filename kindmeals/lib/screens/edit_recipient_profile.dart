...
class EditRecipientProfileScreen extends StatefulWidget {
  final String name;
  final String email;
  final String phone;
  ...
  const EditRecipientProfileScreen({
    super.key,
    required this.name,
    required this.email,
    required this.phone,
  ...
  @override
  State<EditRecipientProfileScreen> createState() => _EditRecipientProfileScreenState();
}

class _EditRecipientProfileScreenState extends State<EditRecipientProfileScreen> {
  ...
  void initState() {
    ...
    recipientIdController = TextEditingController(text: widget.recipientId);
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            buildTextField('Recipient ID', recipientIdController),
